...
/////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class class_SqlTabelleWarenkorb
{
    ...
    private $funktionGueltigeSpaltennamen = array('id', 'kunden_id', 'createTime', 'updateTime');


    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /////////////////     Methode          TicketsInWarenkorb
    /////////////////                      Mit dieser Methode werden Tickets in den WArenkorb verlegt, sofern es noch freie Tickets hat. Die Tickets können nach 10 Minuten seit update Time von anderen Kunden
    /////////////////                      wieder beanspucht werden
    /////////////////
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    public function NeuerEintrag($integer_kunden_id = 0)
    {

        // Zahlen werden getestet ob sie auch wirklich Zahlen sind
        if (!is_numeric($integer_kunden_id)) {
            return "integer_kunden_id muss vom Typ Integer sein. Er ist vom Typ: " . gettype($integer_kunden_id);
        }
        ...
        // Statment definieren
        $statement = DB::get()->prepare(" INSERT INTO warenkorb( kunden_id, createTime, updateTime)
                                                VALUES      ( :kunden_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)");
    ...
    public function Lesen($string_SpaltenBeschriftung = "", $string_ZeilenWertInSpalte = "")
    {
        ...
        if ($string_SpaltenBeschriftung === "" && $string_ZeilenWertInSpalte === "") {
            ...
            // Statment definieren
            $this->statement = DB::get()->prepare("SELECT * FROM warenkorb");
        }
        ...
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            if ($string_SpaltenBeschriftung === $this->funktionGueltigeSpaltennamen[0]) {
                ...
                $this->statement = DB::get()->prepare("SELECT * FROM warenkorb WHERE id = :string_ZeilenWertInSpalteValidiert ");
                // Statment Variablen binden
                ...
                // Statment definieren entsprechend dem String Argument
                $this->statement = DB::get()->prepare("SELECT * FROM warenkorb  WHERE kunden_id = :string_ZeilenWertInSpalteValidiert ");
                // Statment Variablen binden
                $this->statementBinding = array(':string_ZeilenWertInSpalteValidiert' => $this->string_ZeilenWertInSpalteValidiert);
            } // createTime
            else if ($string_SpaltenBeschriftung === $this->funktionGueltigeSpaltennamen[2]) {
                // Statment definieren entsprechend dem String Argument
                $this->statement = DB::get()->prepare("SELECT * FROM warenkorb WHERE createTime = :string_ZeilenWertInSpalteValidiert ");
                // Statment Variablen binden
                $this->statementBinding = array(':string_ZeilenWertInSpalteValidiert' => $this->string_ZeilenWertInSpalteValidiert);
            } // updateTime
            else if ($string_SpaltenBeschriftung === $this->funktionGueltigeSpaltennamen[3]) {
                // Statment definieren entsprechend dem String Argument
                $this->statement = DB::get()->prepare("SELECT * FROM warenkorb WHERE updateTime = :string_ZeilenWertInSpalteValidiert ");
                // Statment Variablen binden
                $this->statementBinding = array(':string_ZeilenWertInSpalteValidiert' => $this->string_ZeilenWertInSpalteValidiert);
    ...
    public function Loeschen($string_SpaltenBeschriftung = "", $string_ZeilenWertInSpalte = "")
    {
        ...
        if ($string_SpaltenBeschriftung === "" && $string_ZeilenWertInSpalte === "") {
            ...
            // Statment definieren
            $this->statement = DB::get()->prepare("DELETE FROM warenkorb");
        }
        ...
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            if ($string_SpaltenBeschriftung === $this->funktionGueltigeSpaltennamen[0]) {
                // Statment definieren entsprechend dem String Argument
                $this->statement = DB::get()->prepare("DELETE FROM warenkorb WHERE id = :string_ZeilenWertInSpalteValidiert ");
                // Statment Variablen binden
                $this->statementBinding = array(':string_ZeilenWertInSpalteValidiert' => $this->string_ZeilenWertInSpalteValidiert);
            } // kunden_id
            else if ($string_SpaltenBeschriftung === $this->funktionGueltigeSpaltennamen[1]) {
                // Statment definieren entsprechend dem String Argument
                $this->statement = DB::get()->prepare("DELETE FROM warenkorb  WHERE kunden_id = :string_ZeilenWertInSpalteValidiert ");
                // Statment Variablen binden
                $this->statementBinding = array(':string_ZeilenWertInSpalteValidiert' => $this->string_ZeilenWertInSpalteValidiert);
            } // createTime
            else if ($string_SpaltenBeschriftung === $this->funktionGueltigeSpaltennamen[2]) {
                // Statment definieren entsprechend dem String Argument
                $this->statement = DB::get()->prepare("DELETE FROM warenkorb WHERE createTime = :string_ZeilenWertInSpalteValidiert ");
                // Statment Variablen binden
                $this->statementBinding = array(':string_ZeilenWertInSpalteValidiert' => $this->string_ZeilenWertInSpalteValidiert);
            } // updateTime
            else if ($string_SpaltenBeschriftung === $this->funktionGueltigeSpaltennamen[3]) {
                // Statment definieren entsprechend dem String Argument
                $this->statement = DB::get()->prepare("DELETE FROM warenkorb WHERE updateTime = :string_ZeilenWertInSpalteValidiert ");
                // Statment Variablen binden
                $this->statementBinding = array(':string_ZeilenWertInSpalteValidiert' => $this->string_ZeilenWertInSpalteValidiert);
            } // Der Eingabestring ist ungültig. Es geschieht kein Zugriff auf die DAtenbank
            else {
    ...
    public function Update($integer_id = -1, $array_updateSpalte = [], $array_updateWert = [], $string_SpaltenBeschriftung = "", $string_ZeilenWertInSpalte = "")
    {
        ...
        if ($integer_id != -1 && $string_SpaltenBeschriftung === "" && $string_ZeilenWertInSpalte === "") {
            ...
            // Statment definieren
            $this->statement = DB::get()->prepare("UPDATE warenkorb SET $ausdruck");
        }
        ...
        //////////////////////////////// ALLE ZEILE MITWERT x IN SPALTEN  - eine oder mehrere Spalten können verändert werden  /////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            // Statment definieren
            $this->statement = DB::get()->prepare("UPDATE warenkorb SET $ausdruck WHERE  $where ");
        }
